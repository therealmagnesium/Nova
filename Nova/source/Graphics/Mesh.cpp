...
namespace Nova::Meshes
{
    Mesh Create(const Vertex* vertices, u32 vertex_count, const u16* indices, u32 index_count)
    {
        ...
        const u64 size_index_buffer = sizeof(u16) * index_count;
        ...
        mesh.vertices.assign(vertices, vertices + size_vertex_buffer);
        mesh.indices.assign(indices, indices + size_index_buffer);
    ...
    Mesh GenerateQuad()
    {
        const Vertex vertices[4] = {
            (Vertex){.position = glm::vec3(-0.5f, 0.5f, 0.f), .color = glm::vec4(1.f, 1.f, 1.f, 1.f), .uv = glm::vec2(0.f, 1.f)},
            (Vertex){.position = glm::vec3(0.5f, 0.5f, 0.f), .color = glm::vec4(1.f, 1.f, 1.f, 1.f), .uv = glm::vec2(1.f, 1.f)},
            (Vertex){.position = glm::vec3(-0.5f, -0.5f, 0.f), .color = glm::vec4(1.f, 1.f, 1.f, 1.f), .uv = glm::vec2(0.f, 0.f)},
            (Vertex){.position = glm::vec3(0.5f, -0.5f, 0.f), .color = glm::vec4(1.f, 1.f, 1.f, 1.f), .uv = glm::vec2(1.f, 0.f)},
        };
